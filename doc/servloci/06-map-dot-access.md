...
Every other feature in this book ([decorators](01-decorators.md),
[`?`](03-try-operator.md), [`@codec`](04-codec-decorator.md),
[`@rpc`](05-rpc-decorator.md)) is a pure source-to-source rewrite done in
...
[`?.`](02-nil-safe-selector.md), which is why this follows that
...
- `typecheck.tcDot` (`src/cmd/compile/internal/typecheck/expr.go`) got
  ...
  reparse-based features ([`@codec`](04-codec-decorator.md),
  [`@rpc`](05-rpc-decorator.md)) for their generated code text, so it's
