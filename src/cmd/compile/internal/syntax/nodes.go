...
type (
	...
	FuncDecl struct {
		...
		Decorators []*Decorator // nil means no decorators
		decl
	}
)

// Decorator represents @decorator or @decorator(args)
type Decorator struct {
	At   Pos       // position of @
	Name *Name     // decorator name
	Call *CallExpr // nil means no arguments, otherwise @name(args)
	node
}
