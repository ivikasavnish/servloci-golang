...
type SelectorExpr struct {
	...
	// NilSafe records whether this selector was written as X?.Sel: if X is
	// nil at runtime, the expression evaluates to the zero value of Sel's
	// type instead of panicking. Lowered in walk (walkDot).
	NilSafe bool
}
